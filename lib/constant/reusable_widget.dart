...
import 'package:b2b_ecommerce/app/modules/search/controllers/search_controller.dart';
import 'package:b2b_ecommerce/app/routes/app_pages.dart';
import 'package:b2b_ecommerce/constant/constants.dart';
    ...
    return GestureDetector(
      ...
      onTap: () {
        Get.toNamed(
          ...
          arguments: {
            'product': controller.prodactData.elementAt(index).id,
          },
        );
      },
      child: Wrap(
          ...
          Container(
            ...
            child: Material(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Image.network(data[index].iamgelink),
                    flex: 2,
                  ),
                  SizedBox(
                    width: 1.5.w,
